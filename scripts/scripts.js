...
window._show_pc_confirmation = function (id, header, detail, show, email) {
  ...
  hideButton.addEventListener("click", function () {
    var submitButton = document.querySelector("#_form_651_submit");
    submitButton.disabled = false;
    submitButton.classList.remove("processing");
    var mp = document.querySelector('input[name="mp"]');
    mp.value = "1";
  ...
  script.onerror = function () {
    if (isSubmit) {
      if (script.src.length > 10000) {
        ...
        _show_error("651", "Sorry, your submission failed. Please try again.");
      }
      submitButton.disabled = false;
      submitButton.classList.remove("processing");
    }
...
(function () {
  ...
  var _removed = false;
  var form_to_submit = document.getElementById("_form_651_");
  ...
  var form_submit = function (e) {
    ...
    if (validate_form()) {
      ...
      var submitButton = e.target.querySelector("#_form_651_submit");
      submitButton.disabled = true;
      submitButton.classList.add("processing");
      var serialized = _form_serialize(
        document.getElementById("_form_651_")
      ).replace(/%0A/g, "\\n");
      var err = form_to_submit.querySelector("._form_error");
...
window._show_pc_confirmation = function (id, header, detail, show, email) {
  ...
  // Add event listener to the button
  hideButton.addEventListener("click", function () {
    var submitButton = document.querySelector("#_form_653_submit");
    submitButton.disabled = false;
    submitButton.classList.remove("processing");
    var mp = document.querySelector('input[name="mp"]');
    mp.value = "1";
  ...
  script.onerror = function () {
    if (isSubmit) {
      if (script.src.length > 10000) {
        ...
        _show_error("653", "Sorry, your submission failed. Please try again.");
      }
      submitButton.disabled = false;
      submitButton.classList.remove("processing");
    }
...
(function () {
  ...
  var _removed = false;
  var form_to_submit = document.getElementById("_form_653_");
  var allInputs = form_to_submit.querySelectorAll("input, select, textarea"),
    tooltips = [],
    submitted = false;
  ...
  var form_submit = function (e) {
    ...
    if (validate_form()) {
      // use this trick to get the submit button & disable it using plain javascript
      var submitButton = e.target.querySelector("#_form_653_submit");
      submitButton.disabled = true;
      submitButton.classList.add("processing");
      var serialized = _form_serialize(
        document.getElementById("_form_653_")
      ).replace(/%0A/g, "\\n");
      var err = form_to_submit.querySelector("._form_error");
      err ? err.parentNode.removeChild(err) : false;
      async function submitForm() {
